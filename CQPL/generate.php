...
<html>
    ...
    <body>
        ...
        <ul class="list-group list-group-flush">
            ...
            <div class="p-2">
                <div class="mb-3">
                <input type="text" class="form-control"  placeholder="Academic Year" name="academic_year" required>
                </div>
            </div>
            <div class="p-2">
                <div class="mb-3">
            ...
            <div class="p-2">
                <div class="mb-3">
                <input type="text" class="form-control "   name="exam" placeholder="Exam" required>
                </div>
            </div>
            </div>
            ...
            <div class="p-2">
                <div class="mb-3">
                <input type="text" class="form-control"  placeholder="Max Marks" name="max_marks" required>
                </div>
            </div>
